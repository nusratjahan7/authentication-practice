...
const SignUpPage = () => {
    ...
    return (
        <>
            ...
            <div className="w-11/12 mx-auto mt-4 flex items-center gap-3 mb-4">
            ...
            <div>
                <div className=" mt-4 pb-3 flex flex-col items-center justify-center px-4 bg-[#0f0f11]">
                    ...
                    <div className="bg-[#19191e] border border-[#2e2e38] shadow-xl px-8 py-9 rounded-2xl ">
                        ...
                        <div>
                            <div className="flex flex-col items-start gap-1 pb-4">
                                ...
                                <p className="text-sm text-gray-400">Join and get started today.</p>
                            </div>
                        </div>
